...
png(filename="C:\\coursera\\exploratary\\plot4.png")
par(mfrow=c(2, 2))
plot(data$dt,data$Global_active_power, type="l", main="power in time",ylab = "Global active power in kw",xlab="time")
plot(data$dt,data$Voltage, type="l", main="power in time",ylab = "voltage" ,xlab= "time")
...
plot(data$dt,data$Global_reactive_power, type="l", main="power in time",ylab = "Global active power in kw",xlab="time")
